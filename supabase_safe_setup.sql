-- Safe setup for the meaning preservation annotation app.
-- This creates missing tables but does NOT delete existing data.
-- Use supabase_clean_reset.sql instead if you want to start over completely.
